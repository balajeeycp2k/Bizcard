...
if SELECT=='Contact':
  name = " Balaji Chakrapani "
  mail = (f'{"Mail :"}  {"Balajeey2k@gmail.com"}')
  social_media = {"GITHUB": "https://github.com/balajeeycp2k ",
                    "LINKEDIN": "www.linkedin.com-in-balaji-chakrapani-371b9049-"
                    }
  st.title(name)
